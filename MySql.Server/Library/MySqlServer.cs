...
namespace MySql.Server
{
    ...
    public class MySqlServer
    {
        ...
        {
            return string.Format("Server=127.0.0.1;Port={0};Protocol=pipe;SslMode=none;", _serverPort.ToString());
        }
        ...
        {
            return string.Format("Server=127.0.0.1;Port={0};Protocol=pipe;SslMode=none;Database={1};", _serverPort.ToString(), databaseName);
        }
